...
| 10 | Usage analytics | `ANALYTICS` | ✅ Good | Send anonymous usage data (service starts, model selection, feature usage) to help improve shardclaw. No personal data, messages, or API keys are ever collected. You can turn this off at any time. |
